...
namespace ModelInfo
{
    ...
    public class CoordinateConverter
    {
        ...
        */
        ...
        public static void UTMXYToLatLonList(int count, double[] x, double[] y, out double[] lgt, out double[] lat, int zone = 37, bool southhemi = true  )
        {
   ...
   //             Console.WriteLine(x[i] + "\t" + y[i]);
        ...
        public static double getUTMDistance(double longitude1, double latitude1, double longitude2, double latitude2)
        {
            ...
            CoordinateConverter.LatLonToUTMXY(latitude1, longitude1, out xx1, out yy1, out z1);
            CoordinateConverter.LatLonToUTMXY(latitude2, longitude2, out xx2, out yy2, out z2);
