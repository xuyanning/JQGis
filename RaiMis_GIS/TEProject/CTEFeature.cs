        ...
        public static void linesPointsLoad(string shpFileName)
        {
            ...
            try
            {
                ...
                //
                {
                    ...
                    string tShapeFileName =CGisDataSettings.gDataPath + CGisDataSettings.gCurrentProject.projectLocalPath + shpFileName + ".shp"; //Path.Combine(SamplesDirectory, @"Resources\ShapeFiles\PointLayers\Captials\World_Capital.shp");
