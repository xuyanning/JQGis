...
namespace GISUtilities
{
    ...
    public class DatabaseWrapper
    {
        ...
        {
            string sqlselect = "select * from MileageNew where longitudeMars is null " ;
            string sqlUpdate = @"update MileageNew set LongitudeMars = @longMars, LatitudeMars = @latMars where MileageID = @mID;  ";
